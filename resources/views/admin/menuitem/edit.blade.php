    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.menuitem.update', $MenuItem->id ) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $MenuItem->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="link" type="link" class="form-control @error('link') is-invalid @enderror" name="link" value="{{ $MenuItem->link }}" required autocomplete="link">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="icon" type="icon" class="form-control @error('icon') is-invalid @enderror" name="icon" value="{{ $MenuItem->icon }}" required autocomplete="icon">
